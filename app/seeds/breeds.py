...
breedList=[
    ...
    },
    {
        ...
        "name": "Russian Toy",
        "breed_group": "Toy",
        "temperament": "Loyal, lively, and friendly",
        "life_span": "10 - 12 years",
    ...
    },
    {
        ...
        "breed_group": "Sporting",
        "bred_for":"Hunting",
        "temperament":"affectionate, outgoing and friendly and makes a loyal companion. Intelligent and relatively easy to train",
        "life_span": "12 - 14 years",
    ...
    },
    {
        ...
        "name": "Xoloitzcuintli",
        "breed_group": "Non-Sporting",
        "bred_for":"protective guides to the next world",
        "life_span": "12 - 14 years",
...
def _avgExercise(breed):
    ...
    sighthounds=["Afghan Hound","Azawakh","Borzoi","Chippiparai","Chortai","Galgo Español","Greyhound","Irish Wolfhound","Italian Greyhound","Kanni","Magyar agár","Mudhol Hound","Patagonian Greyhound","Polish Greyhound","Rajapalayam","Rampur Greyhound","Saluki","Scottish Deerhound","Silken Windhound","Sloughi","Taigan","Tazy","Whippet","Xigou"]
    exceptions={"Shiloh Shepherd":(60//6),"Poodle (Toy)":(60//6),"Poodle (Miniature)":(60//6),"Olde English Bulldogge":(40//6),"Lancashire Heeler":(40//6),"Keeshond":(60//6),"Japanese Spitz":(30//6),"Dutch Shepherd":(90//6),"Barbet":(45//6),"American Bully":(90//6),"Alaskan Husky":(120//6),"Alapaha Blue Blood Bulldog":(80//6)}
    giant={"Great Dane":(30//6),"Bullmastiff":(30//6),"Tibetan Mastiff":(30//6),"Saint Bernard":(30//6),"Newfoundland":(40//6),"Cane Corso":(30//6),"Great Pyrenees":(30//6),"Bernese Mountain Dog":(40//6),"Leonberger":(90//6),"Irish Wolfhound":(40//6),"Scottish Deerhound":(90//60),}
    nonsporting ={"Dalmatian":(120//60),"Coton de Tulear":(30//6),"Appenzeller Sennenhund":(60//6),"Xoloitzcuintli":(25//6),"Tibetan Terrier":(25//6),"American Eskimo Dog":(100//6),"American Eskimo Dog (Miniature)":(60//6),"Bichon Frise":(20//6),"Boston Terrier":(45//6),"Chinese Shar-Pei":(30//6),"Chow Chow":(30//6),"Eurasier":(45//6),"Tibetan Spaniel":(30//6),"Finnish Spitz":(120//6),"French Bulldog":(20//6),"Lhasa Apso":(30//6),"Shiba Inu":(60//6),"Schipperke":(45//6)}

    if breed['name'] in giant:
        return giant[breed['name']]
    elif breed['name'] in nonsporting:
        return nonsporting[breed['name']]
    elif breed['name'] in sighthounds:
        return (30//6)
    elif breed['name'] in exceptions:
...
def seed_breeds():
    for breed in breedList:
        if "bred_for" in breed:
            newBreed = Breed(name=breed['name'], avg_activity_level=_avgExercise(breed), breed_img_url=breed['image']['url'], temperament=breed['temperament'], bred_for=breed['bred_for'], life_span=breed['life_span'], breed_group=breed['breed_group'], weight=breed['weight']['imperial'], height=breed['height']['imperial'])
        else:
